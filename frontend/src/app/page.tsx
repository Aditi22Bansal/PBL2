  ...
  return(
    <>
      ...
      <nav className={`nav${nav?" solid":""}`}>
        <div className="logo">RoomFit<div className="logo-dot"/></div>
      ...
      <section className="hero">
        ...
        <div className="hero-inner">
          <div>
            ...
            <p className="hero-p">RoomFit is a peer-reviewed AI system that matches hostel students by deep lifestyle compatibility — not luck. Built at Symbiosis Institute of Technology. Free for institutions during early access.</p>
      ...
      <div className="free-banner" id="early-access">
        <div>
          ...
          <p className="free-sub">We&apos;re in early research phase. We want institutions to run RoomFit on their real datasets — every new dataset makes the model smarter, more generalizable, and more proven. You get a world-class allocation system. We get richer validation.</p>
      ...
      <section className="results-section" id="results">
        ...
        <div className="btable">
          ...
          {[
            ...
            {m:"RoomFit Hybrid Model",ms:"Proposed — this system",s:"0.95–0.98",d:"±0.015",c:"97–100%",u:"0–2",hi:true},
          ].map(r=>(
      ...
      <section className="cta-section">
        ...
        <div className="cta-in">
          ...
          <p className="cta-sub">RoomFit is completely free for institutions during early access. Help us validate the model on your data — and give your students the compatible living situation they deserve.</p>
      ...
      <footer>
        <div className="footer-grid">
          <div>
            <div className="footer-brand">RoomFit<div className="footer-brand-dot"/></div>
        ...
        <div className="footer-btm">
          <span>© 2025 RoomFit · Symbiosis Institute of Technology, Pune</span>
